package com.tutorial.empbackend.service;

import com.tutorial.empbackend.model.Employee;
import com.tutorial.empbackend.repository.EmployeeRepository;
...
public class EmployeeService implements EmployeeServiceInterface {
    ...
    public Employee updateEmployee(int id, Employee employee) {
        ...
        employeeToUpdate.setDepartmentName(employee.getDepartmentName());
